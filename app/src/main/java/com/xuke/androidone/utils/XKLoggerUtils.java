...
public class XKLoggerUtils {
    private XKLoggerUtils() {
    ...
    // log过滤器
    private static int sLogFilter = V;
    ...
    public static class Builder {
        ...
        public Builder setGlobalTag(String tag) {
            if (!isSpace(tag)) {
                XKLoggerUtils.sGlobalTag = tag;
                sTagIsSpace = false;
            } else {
                XKLoggerUtils.sGlobalTag = "";
                sTagIsSpace = true;
            }
            return this;
        }
        ...
        public Builder setLogSwitch(boolean logSwitch) {
            XKLoggerUtils.sLogSwitch = logSwitch;
            return this;
        }

        public Builder setLog2FileSwitch(boolean log2FileSwitch) {
            XKLoggerUtils.sLog2FileSwitch = log2FileSwitch;
            return this;
        }

        public Builder setBorderSwitch(boolean borderSwitch) {
            XKLoggerUtils.sLogBorderSwitch = borderSwitch;
            return this;
        }

        public Builder setLogFilter(@TYPE int logFilter) {
            XKLoggerUtils.sLogFilter = logFilter;
            return this;
        }
    }
